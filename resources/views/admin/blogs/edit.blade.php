...
@section('content')
    ...
    <section class="content">
        <form action="{{ route('dashboard.blog.update', $blog->id) }}" class="row" method="post"
                ...
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body pb-0">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" value="{{ $blog->translate('ar')->title }}" class="form-control"
                    ...
                    <div class="card-body pb-0">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" value="{{ $blog->translate('ar')->slug }}" class="form-control"
                    ...
                    <div class="card-body pad">
                        <div class="mb-3">
                            ...
                            <textarea class="textEditor" name="ar[content]"
                                ...
                                padding: 10px;">{{ $blog->translate('ar')->content }}</textarea>
                        </div>
                        @error('ar.content')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="card-body pad">
                        <div class="mb-3">
                            ...
                            <textarea maxlength="100" name="ar[short_content]"
                                ...
                                font-size: 14px; line-height: 18px; 
                                border: 1px solid #dddddd; 
                                padding: 10px;">{{ $blog->translate('ar')->short_content }}</textarea>
                        </div>
                    ...
                    <div class="card-body pb-0">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" value="{{ $blog->translate('ar')->seo_title }}" class="form-control"
                    ...
                    <div class="card-body pad">
                        <div class="mb-3">
                            ...
                            line-height: 18px;
                            border: 1px solid #dddddd; 
                            padding: 10px;">{{ $blog->translate('ar')->seo_desc }}</textarea>
                        </div>
                        @error('ar.seo_desc')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
            ...
            <div class="col-md-6 col-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body pb-0">
                        <div class="form-group mb-0">
                            <label for="exampleInputEmail1">عنوان المقال</label>
                            <input type="text" value="{{ $blog->translate('en')->title }}" class="form-control"
                    ...
                    <div class="card-body pb-0">
                        <div class="form-group mb-0">
                            <label for="exampleInputEmail1">Slug المقال</label>
                            <input type="text" value="{{ $blog->translate('en')->slug }}" class="form-control"
                    ...
                    <div class="card-body pad">
                        <div class="mb-3">
                            ...
                            <textarea class="textEditor" name="en[content]"
                                ...
                                font-size: 14px; line-height: 18px;
                                border: 1px solid #dddddd; 
                                padding: 10px;">{{ $blog->translate('en')->content }}</textarea>
                        </div>
                        @error('en.content')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="card-body pad">
                        <div class="mb-3">
                            ...
                            <textarea maxlength="100" name="en[short_content]"
                                ...
                                font-size: 14px; line-height: 18px; 
                                border: 1px solid #dddddd; 
                                padding: 10px;">{{ $blog->translate('en')->short_content }}</textarea>
                        </div>
                    ...
                    <div class="card-body pb-0">
                        <div class="form-group mb-0">
                            <label for="exampleInputEmail1">عنوان المقال (SEO) </label>
                            <input type="text" value="{{ $blog->translate('en')->seo_title }}" class="form-control"
                    ...
                    <div class="card-body pad">
                        <div class="mb-3">
                            ...
                            <textarea class="textarea" name="en[seo_desc]" rows="4"
                                ...
                                font-size: 14px; line-height: 18px;
                                border: 1px solid #dddddd; 
                                padding: 10px;">{{ $blog->translate('en')->seo_desc }}</textarea>
                        </div>
                        @error('en.seo_desc')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
            ...
            <div class="form-group bg-white mb-4 d-flex justify-content-center"
                ...
                <img src="{{ asset('uploads/' . $blog->image) }}" class="img-fluid mb-2 col-10" alt="Responsive image">
            </div>
            ...
            <div class="form-group bg-white mb-4 d-flex justify-content-center"
                ...
                border: 1px solid rgba(0, 0, 0, .125);
                border-radius: 0.25rem;">
                <img src="{{ asset('uploads/' . $blog->cover) }}" class="img-fluid mb-2 col-10" alt="Responsive image">
            </div>
            <div class="form-group bg-white mb-4"
                style="
                width: 100%;
