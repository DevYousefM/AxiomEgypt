...
return [
    ...
    'attributes'           => [
        ...
        'en' => [
            ...
            "content" => 'المقال باللغة الانجليزية',
            "seo_title" => 'عنوان الSEO باللغة الانجليزية',
            "seo_desc" => 'وصف الSEO باللغة الانجليزية',
        ],
        'ar' => [
            "title" => 'العنوان باللغة العربية',
            "content" => 'المقال باللغة العربية',
            "seo_title" => 'عنوان الSEO باللغة العربية',
            "seo_desc" => 'وصف الSEO باللغة العربية',
        ]
    ],
];
